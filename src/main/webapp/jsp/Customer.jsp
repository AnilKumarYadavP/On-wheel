        ...
        <div class="item-box2">
            <div class="items3">
                ...
                <div class="the" style="margin-left: 0px;">
                    <h1 style="color: white;margin-left: -100px;"><i>Welcome TO Customer-Login</i></h1>
                </div>
            ...
            <div class="items4">
               <div class="item-box">
                ...
                <form action="/customer/login" method="post" class="form">
                    <fieldset>
                        ...
                        <button style="margin-left: 65px;" class="cancel">Cancel</button><br><br>
                        <a href="/customer/register" class="reg" style="color: yellow;">Register?If new User</a>
