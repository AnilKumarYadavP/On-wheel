        ...
        <div class="item-box2">
            <div class="items3">
                ...
                <div class="the" style="margin-left: 0px;">
                    <h1 style="color: white;margin-left: -100px;"><i>Welcome TO Admin-Login</i></h1>
                </div>
               ...
               <div class="item-box">
                <form action="/admin/login" class="form" method="post">
                    <fieldset>
                        ...
                        <button style="margin-left: 65px;" class="cancel">Cancel</button>
                        <br><br>
